...
class Player:
    ...
    # "pegar" as cartas na mão do jogador
    @property
    def mao(self):
        return self.__mao
    ...
    def apostar(self, valor):
        ...
        if valor <= self.__fichas: # verificar se o jogador tem as fichas para apostar
            self.__fichas -= valor
            return valor  
        else:
...
class Jogo:
    ...
    def jogar(self):
        ...
        while True:
                ...
                while True:
                    ...
                    if acao_escolhida == '1':
                        ...
                        if pontuacao == 21:
                            ...
                            jogador.receber_fichas(aposta * 2)  # receber o dobro da aposta
                            self.__verificar_vencedor()  # verificar se há um vencedor
                            return
                        # derrota (quando estourar, o jogador perde)
                        elif pontuacao > 21:
            ...
            if self.__vencedor:
                print(self.__vencedor.nome, ", você venceu! >.< Congrats ! !")
